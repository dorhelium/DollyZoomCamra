...
public class CanvasCam2 implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        final FlatMatrix4d P2 = new FlatMatrix4d();
        final FlatMatrix4d V2 = new FlatMatrix4d();
        gl.glGetDoublev( GL2.GL_MODELVIEW_MATRIX, P2.asArray(), 0 );
		P2.reconstitute();
		gl.glGetDoublev( GL2.GL_MODELVIEW_MATRIX, V2.asArray(), 0 );
		V2.reconstitute();
		...
		gl.glMultMatrixd(Pinv.asArray(),0);    //frustum
		gl.glColor3f(1,0,0);
		...
		/* Test code to draw a shifted frustum to see the converging focal plane
		////////////////////////////////////
		 final FlatMatrix4d P1 = new FlatMatrix4d();
	     final FlatMatrix4d Pinv1 = new FlatMatrix4d();
	     final FlatMatrix4d V1 = new FlatMatrix4d();
	     final FlatMatrix4d Vinv1 = new FlatMatrix4d();
		gl.glPushMatrix();
        gl.glLoadIdentity();
        dofCam.setupProjection( drawable, 1 );
        gl.glGetDoublev( GL2.GL_MODELVIEW_MATRIX, P1.asArray(), 0 );
		P1.reconstitute();
		Pinv1.getBackingMatrix().invert( P1.getBackingMatrix() );
		gl.glLoadIdentity();
        dofCam.setupViewingTransformation( drawable, 1 );
        gl.glGetDoublev( GL2.GL_MODELVIEW_MATRIX, V1.asArray(), 0 );
		V1.reconstitute();
		Vinv1.getBackingMatrix().invert( V1.getBackingMatrix() );
		gl.glPopMatrix();
		
		 gl.glPushMatrix();
			// here is some code to draw a fancy axis
	        gl.glMultMatrixd(Vinv1.asArray(),0);
	        FancyAxis fb = new FancyAxis();
			fb.draw(gl);
		gl.glDisable( GL2.GL_LIGHTING );
		gl.glMultMatrixd(Pinv1.asArray(),0);    //frustum2
		gl.glColor3f(1,0,0);
		glut.glutWireCube(2);
		gl.glEnable( GL2.GL_LIGHTING );
		gl.glPopMatrix();
